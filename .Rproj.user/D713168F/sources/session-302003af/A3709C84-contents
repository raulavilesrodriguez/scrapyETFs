...
This program analyzes all ETFs listed on the NY Stock Exchange to obtain the highest profitability considering financial indicators such as returns, risks.
